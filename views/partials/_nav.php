        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="./index" class="<?php echo URIs('/index') ? "bg-gray-900 " : "text-gray-300" ?> text-white px-3 py-2 rounded-md text-sm font-medium" aria-current="page">Dashboard</a>
              ...
              <a href="./about" class="<?php echo $_SERVER['REQUEST_URI'] === '/codes/refresh/about.php' ? "bg-gray-900 " : "text-gray-300" ?> text-white hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">About</a>
